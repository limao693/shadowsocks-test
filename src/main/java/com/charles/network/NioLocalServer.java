package com.charles.network;

import com.charles.Constant;
import com.charles.misc.Config;
import com.charles.misc.Util;
import com.charles.network.nio.ChangeRequest;
import com.charles.network.nio.PipeWorker;
import com.charles.network.nio.RemoteSocketHandler;
import com.charles.network.nio.SocketHandlerBase;
...
public class NioLocalServer extends SocketHandlerBase{
    ...
    public NioLocalServer(Config config) throws IOException, InvalidAlgorithmParameterException {
        ...
        //print server info
        logger.info("ShadowSockes-test v" + Constant.VERSION);
        logger.info("Cipher: " + config.getMethod());
        logger.info(config.get_proxyType() + " Proxy Server starts at port: " + config.getLocalPort());
    }
    ...
    private void accept (SelectionKey key) throws IOException{
        ...
        //creat pipe between local and remote socket
